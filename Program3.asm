# Display 12 values in decreasing order by 7, getting the first name by the user input
# CHangsong Li
	.data
...
MAIN:	la   $s0,  num			# load address of num for use
	...
	addi $v0,  $zero,  5		# ready to read int from user
	syscall				# read int from user
	move $t2,  $v0			# put user input to $t2
